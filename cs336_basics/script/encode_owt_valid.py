...
if __name__ == "__main__":
    ...
    train_output_path = "/mnt/disk3/yusheng/assignment1-basics/data/tokenizer/train_token_ids_32000.npy"
    valid_output_path = "/mnt/disk3/yusheng/assignment1-basics/data/tokenizer/valid_token_ids_32000_2.npy"
